    ...
    <footer className="mt-20 border-t border-line bg-bg">
      <div className="mx-auto max-w-page px-6 py-12">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          <div>
            <h2 className="text-lg font-black italic text-brand">제안서몰</h2>
            <p className="mt-3 text-[13px] leading-7 text-ink-sub">
          ...
          <div>
            <h3 className="text-[13px] font-bold text-ink">고객지원</h3>
            <ul className="mt-3 space-y-2 text-[13px] text-ink-sub">
              <li>
          ...
          <div>
            <h3 className="text-[13px] font-bold text-ink">파일 접수</h3>
            <p className="mt-3 text-[13px] leading-7 text-ink-sub">
