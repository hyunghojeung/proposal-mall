    ...
    <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr]">
      ...
      <aside className="rounded border border-line bg-white p-7">
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-3 rounded border-2 border-brand py-4 text-[18px] font-bold text-brand transition-colors hover:bg-brand hover:text-white"
        >
