              ...
              <table className="w-full border-collapse text-[14px]">
                ...
                <thead>
                  <tr className="border-b border-line bg-bg text-[13px] text-ink-sub">
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">주문번호</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">주문자</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">연락처 / 이메일</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">결제</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">상품</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">수령</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">상태</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-right font-semibold">금액</th>
                    <th className="whitespace-nowrap px-4 py-3.5 text-left font-semibold">주문일시</th>
                  </tr>
                </thead>
                <tbody>
                  {orders.map((o) => {
                    ...
                    return (
                      <tr key={o.serial} className="border-b border-line transition-colors hover:bg-[#fff8f6]">
                        ...
                        <td className="whitespace-nowrap px-4 py-4">
                          ...
                          {o.company && <p className="mt-0.5 text-[12px] text-ink-sub truncate">{o.company}</p>}
                        </td>
                        <td className="whitespace-nowrap px-4 py-4">
                        ...
                        <td className="px-4 py-4">
                          <Link href={`/orders/${o.serial}`}
                            className="block max-w-[180px] truncate text-[14px] text-ink hover:text-brand hover:underline">
                            {summary}
                          </Link>
                        </td>
                        <td className="whitespace-nowrap px-4 py-4 text-[13px] text-ink-sub">{delivery}</td>
                        <td className="whitespace-nowrap px-4 py-4">
                        ...
                        <td className="whitespace-nowrap px-4 py-4 text-[13px] text-ink-del">
